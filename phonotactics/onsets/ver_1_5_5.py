...
from coventreiya.phonology.consonants.ver_1_5_5 import ver_1_5_5 as cons_ver
...
class ver_1_5_5( Onsets ):
    def __init__(self):
        min_length = 1
        max_length = 7
        super().__init__(min_length,max_length,1,5,5)
...
ons_ = register( ver_1_5_5(), gen_ver_1_5_5 )
